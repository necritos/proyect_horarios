...
-- Dumping data for table horarios.grupo: ~5 rows (approximately)
...
-- Dumping data for table horarios.grupo_tipo_dictado: ~10 rows (approximately)
...
-- Dumping data for table horarios.horario: ~6 rows (approximately)
